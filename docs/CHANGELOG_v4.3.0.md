...
### GitHub #146: Second Report on Board `88D2`, Already Covered by an Existing Entry

Same board (`88D2`, OMEN 15z-en100) as [#132](https://github.com/theantipopau/omencore/issues/132), which already has a conservative entry from an earlier session. Updated that entry's notes to cite [#146](https://github.com/theantipopau/omencore/issues/146) (fans stuck at 100% until an app restart) alongside #132 — not a capability-flag fix, both reports need a fresh diagnostics export captured during the actual misbehavior to trace further, which neither currently has. (This pass briefly added a duplicate, conflicting `88D2` entry before checking for the existing one; the full test suite's failure on the resulting ambiguity caught it immediately, and it was reverted before shipping.)

### GitHub Issue Sweep: 10 Field Reports Closed With Confirmed Fixes

Audited the backlog of older open issues against the current codebase and closed 10 that already have a real, unconditional fix landed in an earlier cycle but were never replied-to or closed on GitHub: [#121](https://github.com/theantipopau/omencore/issues/121)/[#125](https://github.com/theantipopau/omencore/issues/125)/[#129](https://github.com/theantipopau/omencore/issues/129) (boards `8A43`/`8C3F` given exact entries; AMD Ryzen CPU-temperature worker-preference fix), [#135](https://github.com/theantipopau/omencore/issues/135)/[#138](https://github.com/theantipopau/omencore/issues/138)/[#139](https://github.com/theantipopau/omencore/issues/139)/[#140](https://github.com/theantipopau/omencore/issues/140) (boards `8C30`/`8DCD`/`88EE` given exact entries with working performance-mode/fan-control profiles), [#137](https://github.com/theantipopau/omencore/issues/137) (board `8BCD`'s ACPI-WMAA-abort downgrade, already shipped, fixes exactly the `full-control`-when-it-isn't symptom reported), [#141](https://github.com/theantipopau/omencore/issues/141) (Fn+F2/OMEN-key VK-scan-code collision, already pinned by a regression test), and [#144](https://github.com/theantipopau/omencore/issues/144) (board `8A18` exact entry). Several others got evidence-based replies without a code change ([#124](https://github.com/theantipopau/omencore/issues/124), [#128](https://github.com/theantipopau/omencore/issues/128), [#131](https://github.com/theantipopau/omencore/issues/131), [#134](https://github.com/theantipopau/omencore/issues/134), [#142](https://github.com/theantipopau/omencore/issues/142), [#143](https://github.com/theantipopau/omencore/issues/143)) — see `docs/ROADMAP_v4.3.0.md` for the `#126` capability-classifier finding this sweep also surfaced.
