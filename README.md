...
- **Fixed:** in-app updates never worked on release builds — installed copies were detected as portable and downloaded the zip. Fixed for updates from 4.4.0 onward; from 4.3.1, download the installer manually.
