...
Complete installation, upgrade, portable, Linux, and uninstall instructions for OmenCore 4.3.0.

## Choose Your Package

| Package | Platform | Use This When |
|---|---|---|
| `OmenCoreSetup-4.3.0.exe` | Windows | You want the normal install flow, Start Menu entry, and optional PawnIO install. |
| `OmenCore-4.3.0-win-x64.zip` | Windows | You want a portable copy, test build, or no installer changes. |
| `OmenCore-4.3.0-linux-x64.zip` | Linux | You want the CLI and Avalonia GUI bundle. |
...
1. Download `OmenCoreSetup-4.3.0.exe`.
...
1. Download `OmenCore-4.3.0-win-x64.zip`.
2. Verify the SHA256 hash from the GitHub Release notes.
...
For maintainers preparing 4.3.0:
...
```powershell
Get-FileHash artifacts\OmenCoreSetup-4.3.0.exe -Algorithm SHA256
Get-FileHash artifacts\OmenCore-4.3.0-win-x64.zip -Algorithm SHA256
Get-FileHash artifacts\OmenCore-4.3.0-linux-x64.zip -Algorithm SHA256
```

`artifacts\SHA256SUMS-4.3.0.txt` can be uploaded alongside the artifacts. Publish those hashes in the GitHub Release notes. Do not publish an in-app update without SHA256 hashes.

## Additional Resources

- [README.md](README.md)
- [docs/CHANGELOG_v4.3.0.md](docs/CHANGELOG_v4.3.0.md)
